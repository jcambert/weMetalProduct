...
class WeProfile(Model):
    _name='we.profile'
    _description='Standard Profile Dimension'
    _sql_constraints = [
        ('we_profile_name_uniq','unique(protype,name)',"The name of this profile type must be unique"),
    ]
    name=fields.Char('Name',required=True,index=True)
    protype=fields.Many2one('we.profile.type',required=True,string="Type")
