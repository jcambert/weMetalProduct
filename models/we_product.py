...
class WeProduct(models.Model):
    ...
    @api.depends('sheet_width','sheet_length','sheet_thickness','material')
    ...
    def _check_material_values_width(self):
        for record in self:
            if not record.is_sheetmetal:
                continue
    ...
    def _check_material_values_length(self):
        for record in self:
            if not record.is_sheetmetal:
                continue
    ...
    def _check_material_values_thickness(self):
        for record in self:
            if not record.is_sheetmetal:
                continue
